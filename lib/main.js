...
function createHandler(options) {
  var _options$sourcePrefix, _options$cachePrefix;
  ...
  var sourcePrefix = (_options$sourcePrefix = options.sourcePrefix) !== null && _options$sourcePrefix !== void 0 ? _options$sourcePrefix : "";
  var cachePrefix = (_options$cachePrefix = options.cachePrefix) !== null && _options$cachePrefix !== void 0 ? _options$cachePrefix : "";
  ...
  return function handleRequest(req, res) {
    ...
    var targetPath = cachePrefix + target;
    var sourcePath = sourcePrefix + source;
